...
function setup() {
	...
	boxL = Bodies.rectangle(width/2-80,610,20,100,{isStatic:true});
	World.add(world, boxL);
	boxR = Bodies.rectangle(width/2+80,610,20,100,{isStatic:true});
	World.add(world, boxR);
	boxB = Bodies.rectangle(width/2,650,200,20,{isStatic:true});
